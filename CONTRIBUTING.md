# Contributing to marklogic-service-broker

marklogic-service-broker welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use marklogic-service-broker, please direct these to Stack Overflow with the "marklogic" tag.
...
* **marklogic-service-broker Version** - is it a named version or from our master branch
...
#### Fork marklogic-service-broker

Fork the project [on GitHub](https://github.com/thomaswmcgrath/marklogic-service-broker/fork) and clone
your copy.
...
```
Fixing Issue #123: make the whatchamajigger work with MarkLogic 8
...
It would be really nice to improve marklogic-service-broker's testing. If you add new functions
...
Go to https://github.com/username/marklogic-service-broker and select your feature branch. Click
